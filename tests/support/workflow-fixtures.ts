import type { AssistantResult, SeasonReviewAssistant, SeasonReviewAssistantRequest, SeasonSetupAssistant, SeasonSetupAssistantRequest, SeasonSetupSuggestion, SeasonWorkflowDependencies, WorkflowIdGenerator } from "../../src/application";
...
export function workflowContext():SeasonWorkflowDependencies{return {setupDrafts:new InMemorySeasonSetupDraftRepository(),reviews:new InMemorySeasonReviewRepository(),seasons:new InMemorySeasonRepository(),clock:new FixedClock(),ids:new WorkflowIds()};}
